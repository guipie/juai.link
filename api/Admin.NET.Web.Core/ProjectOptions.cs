...
public static class ProjectOptions
{
    ...
    public static IServiceCollection AddProjectOptions(this IServiceCollection services)
    {
        ...
        services.AddConfigurableOptions<ChatGPTOptions>();
        services.AddConfigurableOptions<XunfeiOptions>();
        services.AddConfigurableOptions<BaiduOptions>();
        services.AddConfigurableOptions<AlibabaOptions>();
        services.AddConfigurableOptions<TencentOptions>();
        services.AddConfigurableOptions<LeptonaiOptions>(); 

        services.AddConfigurableOptions<TencentSmsOptions>();
        return services;
    }
}